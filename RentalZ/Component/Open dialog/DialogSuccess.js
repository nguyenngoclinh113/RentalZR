...
const DialogSuccess = ({name, show, setShow}) => {
    const Closemode = ()=>{
        setShow(false)
    }
    return (
          ...
          <View style={styles.modelForm}>
              <View style={styles.Boxder}>
                ...
                <View style={{alignItems:'center'}}>
                    <Icon style={styles.iconerror} name="checkmark-circle" size={90} color="#34eb34" />
                </View>
                <View style={{alignItems:'center'}}>
                    <Text style={styles.content}>Congratulations on your successful creation!</Text>
                </View>
                <View style={{alignItems:'center'}}>
